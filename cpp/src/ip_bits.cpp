...
const IpBits* IpBits::v4() {
  ...
  v4Ptr = new IpBits(IpVersion::V4, ipv4_as_compressed, ipv4_as_compressed, 32, 8, 8, "in-addr.arpa", 1 << 8, Crunchy::one());
  return v4Ptr;
}
...
const IpBits* IpBits::v6() {
  ...
  v6Ptr = new IpBits(IpVersion::V6, ipv6_as_compressed, ipv6_as_uncompressed, 128, 16, 4, "ip6.arpa", 1 << 16, Crunchy::zero());
  return v6Ptr;
}
