...
class IpBits {
 ...
 private:
  IpBits(IpVersion version, ToString vt_as_compressed_string, ToString vt_as_uncompressed_string, size_t bits, size_t part_bits,
         size_t dns_bits, const char* rev_domain, size_t part_mod, const Crunchy& host_ofs)
      : version(version),
 ...
 public:
  ...
  std::string as_compressed_string(const Crunchy& bu) const { return (this->vt_as_compressed_string)(this, bu); }
  std::string as_uncompressed_string(const Crunchy& bu) const { return (this->vt_as_uncompressed_string)(this, bu); }
