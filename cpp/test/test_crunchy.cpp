...
int main(int, char **) {
  ...
  describe("#div", []() {
    ...
    it("Shouldn't divide by zero", []() {
      ...
      try {
        x.div(y);
        assert.isTrue(false, "never should touched");
  ...
  describe("#mod", []() {
    ...
    //
    //   assert.deepEqual(x.mod(y).to_8bit(), {2});
    // });
    //
    // it("Should calculate modulo of negative", []() {
    ...
    //
    //   assert.deepEqual(x.mod(y).to_8bit(), {5});
    // });
    //
    // it("Should calculate modulo of negative", []() {
  ...
  describe("#rightShift", []() {
    ...
    it("Should right shift a number to zero", []() {
      ...
      assert.deepEqual(x.shr(32).to_8bit(), {0});
      assert.deepEqual(x.shr(33).to_8bit(), {0});
    });
