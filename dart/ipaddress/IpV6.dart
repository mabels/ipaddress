...
class IpV6 {
    ...
    ///
     ...
     static final VtBool ipv6_is_loopback = (IPAddress my) => my.host_address == BigInt.from(0);
     static final VtBool ipv6_is_private = (IPAddress my) => IPAddress.parse("fd00::/8").unwrap().includes(my);
     ...
     static Result<IPAddress> enhance_if_mapped(IPAddress ip) {
        ...
        if(ipv6_top_96bit == BigInt.from(0xffff)) {
            ...
            final mapped = IpV4.from_u32(num.toInt(), ipv4_bits.bits-ip.prefix.host_prefix());
            if(mapped.isErr()) {
