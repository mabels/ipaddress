...
describe('Ipv4Test', () => {
    ...
    it("test_method_each", () => {
        ...
        assertArrayEqual(arr, ["10.0.0.0", "10.0.0.1", "10.0.0.2", "10.0.0.3", "10.0.0.4", "10.0.0.5",
                "10.0.0.6", "10.0.0.7"]);
    }
    );
    it("test_method_size", () => {
    ...
    it("test_classmethod_summarize", () => {
        ...
        assertArrayEqual(IPAddress.to_string_vec(IPAddress.summarize([setup().ip])),
