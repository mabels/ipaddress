...
// import Prefix128 from '../src/prefix128.js';
import Ipv6Unspec from "../src/ipv6_unspec.js";
import Crunchy from "../src/crunchy.js";

interface IPv6UnspecifiedTestParams {
  ip: IPAddress;
  to_s: string;
  to_string: string;
...
class IPv6UnspecifiedTest {
  ...
  to_string_uncompressed: string;
  num: Crunchy;
  constructor(obj: IPv6UnspecifiedTestParams) {
    this.ip = obj.ip;
    this.to_s = obj.to_s;
