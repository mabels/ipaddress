...
public class Prefix {
  ...
  public func eq(_ other: Prefix) -> Bool {
    return self.ip_bits.version == other.ip_bits.version && self.num == other.num
  }
  public func ne(_ other: Prefix) -> Bool {
    return !self.eq(other)
  }
  public func cmp(_ oth: Prefix) -> Int {
    if self.ip_bits.version != oth.ip_bits.version && self.ip_bits.version == IpVersion.V4 {
      return -1
    } else if self.ip_bits.version != oth.ip_bits.version && self.ip_bits.version == IpVersion.V6 {
      return 1
    } else {
      if self.num < oth.num {
        return -1
