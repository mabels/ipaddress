...
public class Ipv4 {
  ...
  public class func is_class_a(_ my: IPAddress) -> Bool {
    ...
    return my.is_ipv4() && my.host_address < BigUInt(0x8000_0000)
  }
  ...
  public class func is_class_b(_ my: IPAddress) -> Bool {
    return my.is_ipv4() && BigUInt(0x8000_0000) <= (my.host_address)
      && my.host_address < BigUInt(0xc000_0000)
  }
  ...
  public class func is_class_c(_ my: IPAddress) -> Bool {
    return my.is_ipv4() && BigUInt(0xc000_0000) <= my.host_address
      && my.host_address < BigUInt(0xe000_0000)
  }
