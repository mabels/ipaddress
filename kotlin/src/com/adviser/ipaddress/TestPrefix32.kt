...
class Prefix32Test (String netmask0, String netmask8, String netmask16,
    ...
    String netmask24
    String netmask30
    Vector<String> netmasks = Vector<String>()
    HashMap<String, Integer> prefix_hash = HashMap<String, Integer>()
    HashMap<List<Integer>, Integer> octets_hash = HashMap<List<Integer>, Integer>()
    HashMap<Integer, Long> u32_hash = HashMap<Integer, Long>()
    {
...
class TestPrefix32 {
    ...
    public fun Prefix32Test setup() {
        var p32t = Prefix32Test(
            "0.0.0.0",
            "255.0.0.0",
            "255.255.0.0",
            "255.255.255.0",
