...
val to_ipv6: VtIPAddress = { ia -> IPAddress(
                IpBits.V6,
...
class IpV4 {
    companion object {
        ...
        public fun from_u32(addr: Long, _prefix: Int): Result<IPAddress> {
        ...
        public fun create(str: String): Result<IPAddress> {
        ...
        public fun is_class_a(my: IPAddress): Boolean {
        ...
        //      // => true
        //
        public fun is_class_b(my: IPAddress): Boolean {
        ...
        public fun is_class_c(my: IPAddress): Boolean {
        ...
        //
        public fun parse_classful(ip_s: String): Result<IPAddress> {
