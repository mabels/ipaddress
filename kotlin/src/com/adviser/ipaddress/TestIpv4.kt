...
class IPv4Prefix(ip: String, prefix: Int) {
    public val ip = ip
    public val prefix = prefix
}

class IPv4Test(invalid_ipv4: Array<String>, valid_ipv4_range: Array<String>,
    ip: IPAddress, network: IPAddress,
    class_a: IPAddress, class_b: IPAddress, class_c: IPAddress) {
    val invalid_ipv4 = invalid_ipv4
    val valid_ipv4_range = valid_ipv4_range
    var ip = ip
    var network = network
    var class_a = class_a
    var class_b = class_b
    var class_c = class_c
    public val valid_ipv4 = HashMap<String, IPv4Prefix>()
    public val netmask_values = HashMap<String, String>()
    public val decimal_values = HashMap<String, Long>()
    public val networks = HashMap<String, String>()
    public val broadcast = HashMap<String, String>()
    public val classful = HashMap<String, Int>()
...
class TestIpv4 {
   ...
   @Test
    public fun test_initialize_format_error() {
   ...
   @Test
    public fun test_initialize_without_prefix() {
   ...
   @Test
    public fun test_method_network() {
   ...
   @Test
    public fun test_method_each_host() {
   ...
   @Test
    public fun test_method_include_all() {
   ...
   @Test
    public fun test_method_private() {
        assertEquals(true,
   ...
   @Test
    public fun test_method_compare() {
   ...
   @Test
    public fun test_method_netmask_equal() {
   ...
   @Test
    public fun test_method_supernet() {
   ...
   @Test
    public fun test_classmethod_parse_u32() {
        setup().decimal_values.forEach[addr,value |
   ...
   @Test
    public fun test_classmethod_parse_classful() {
