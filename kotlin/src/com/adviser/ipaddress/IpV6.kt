...
class IpV6 {
    ...
    companion object {
        ...
        public fun from_str(str: String, radix: Int, prefix: Int): Result<IPAddress> {
            try {
        ...
        public fun enhance_if_mapped(ip: IPAddress): Result<IPAddress>
        {
        ...
        public fun from_int(bi: BigInteger, prefixNum: Int): Result<IPAddress>
        {
