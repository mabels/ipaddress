...
class IpV4 {
    public static final IPAddress.VtBool ipv4_is_private = [ IPAddress my |
    ...
    public static final IPAddress.VtIPAddress to_ipv6 = [IPAddress ia |
    ...
    static def Result<IPAddress> from_u32(long addr, int _prefix) {
        ...
        return Result.Ok(new IPAddress(
                IpBits::v4(),
